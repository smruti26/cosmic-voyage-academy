...
export const Route = createFileRoute("/planets")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Tour all 8 planets of the Solar System in 3D, from Mercury to Neptune. Sizes, moons, fun facts and orbits explained for kids." },
      { property: "og:title", content: "The Planets — Cosmoverse" },
      { property: "og:description", content: "Interactive 3D tour of Mercury, Venus, Earth, Mars, Jupiter, Saturn, Uranus and Neptune." },
    ],
  }),
  component: Planets,
});
...
const PLANETS: PlanetInfo[] = [
  { name: "Mercury", color: "#b1aca5", tagline: "The swift messenger closest to the Sun.",
  ...
  { name: "Venus", color: "#e8b07a", emissive: "#d28848", tagline: "Earth's scorching, cloud-wrapped twin.",
  ...
  { name: "Earth", color: "#3a8dff", tagline: "The pale blue dot we call home.",
  ...
  { name: "Mars", color: "#d2532f", tagline: "The rusty desert world with giant volcanoes.",
  ...
  { name: "Jupiter", color: "#d8a872", tagline: "The king of planets — a gas giant of storms.",
  ...
  { name: "Saturn", color: "#e6c98a", ring: true, ringColor: "#d6b272", tagline: "The jewel of the Solar System.",
  ...
  { name: "Uranus", color: "#9fdfe8", ring: true, ringColor: "#7fbfd0", tagline: "The tilted ice giant rolling on its side.",
  ...
  { name: "Neptune", color: "#4868c8", tagline: "The windy blue world at the edge.",
...
function Planets() {
  const [active, setActive] = useState(2); // Earth
      ...
      <div className="mx-auto max-w-7xl px-6">
        <header className="max-w-2xl">
          ...
          <p className="mt-4 text-muted-foreground text-lg">
            Eight worlds dance around our Sun. Pick one to spin it, study it, and learn its secrets.
          </p>
        </header>
        ...
        <div className="mt-12 grid lg:grid-cols-2 gap-10 items-center">
          ...
          <div className="relative aspect-square w-full glass rounded-3xl overflow-hidden">
            ...
            >
              ...
              <PlanetScene color={p.color} emissive={p.emissive} ring={p.ring} ringColor={p.ringColor} />
            </ClientCanvas>
          </div>
